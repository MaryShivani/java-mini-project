...
public static void main(String arg[])
{
 ...
 String subject[] = { "Mathematics", "oops", "Physics","Computer Programming","Electrical & Electronics","chemistry"}; String subcode[]= { "MA-102","HU-103","PY-101","CS-103","EE-101","ME-101"};
...
for(i=0;i<6;i++)
{
  ...
  System.out.println("================================================================================");
  System.out.println("\t\t College:\t"+"College of Engineering and technology, Chennai");
  System.out.print("\n\t\t Name:          " +name);
